...
// Reference: http://codereview.stackexchange.com/questions/14730/impossibly-fast-delegate-in-c11
...
class delegate<R(A...)>
{
    ...
    delegate(void* const o, stub_ptr_type const m) noexcept
        : object_ptr_(o), stub_ptr_(m), deleter_(nullptr), store_size_(0)
    {
    }
...
public:
    ...
    explicit delegate(C const* const o) noexcept
        : object_ptr_(const_cast<C*>(o)), deleter_(nullptr), store_size_(0)
    {
    }
    ...
    template <typename T, typename ::std::enable_if < !::std::is_same<delegate, typename ::std::decay<T>::type>{} > ::type >
    delegate(T&& f)
