...
*/
// Edited by Malius Arth 2017

#pragma once

#ifndef  MA_PREDEF_VERSION_NUMBER_INCLUDE_GUARD
#define  MA_PREDEF_VERSION_NUMBER_INCLUDE_GUARD

/*`
[heading ` MA_VERSION_NUMBER`]

``
 MA_VERSION_NUMBER(major,minor,patch)
``
...
*/
#define  MA_VERSION_NUMBER(major,minor,patch) \
    ( (((major)%100)*10000000) + (((minor)%100)*100000) + ((patch)%100000) )

#define  MA_VERSION_NUMBER_MAX \
     MA_VERSION_NUMBER(99,99,99999)

#define  MA_VERSION_NUMBER_ZERO \
     MA_VERSION_NUMBER(0,0,0)

#define  MA_VERSION_NUMBER_MIN \
     MA_VERSION_NUMBER(0,0,1)

#define  MA_VERSION_NUMBER_AVAILABLE \
     MA_VERSION_NUMBER_MIN

#define  MA_VERSION_NUMBER_NOT_AVAILABLE \
     MA_VERSION_NUMBER_ZERO
