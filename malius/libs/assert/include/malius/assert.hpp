...
//	class Assert
//	{
//		const log::SourceInfo& sourceInfo_;
//	public:
//		// logs the formatted message
//		Assert(const log::SourceInfo& sourceInfo, const char* format, ...) : sourceInfo_(sourceInfo)
//		{
//			//using namespace log;
...
//}
//
//#define MA_ASSERT_MACRO_TOGGLE 1
//
	...
	namespace test
	{
		namespace assert
		{
			inline void test1234()
			{
				...
				//_MA_PP_FOR_EACH(MA_ASSERT_IMPL_VAR, (penis.c_str()), (test1), (test2));


				//_MA_PP_FOR_EACH(MA_ASSERT_IMPL_VAR, penis.c_str(), test1);


				//_MA_PP_FOR_EACH(MA_ASSERT_IMPL_VAR, (penis.c_str()));
				...
				MA_ASSERT(false, "PenisSize: %i", 42)(test1);
				...
				//_MA_PP_FOR_EACH_2(_MA_PP_FOR_EACH_0, "penis");
