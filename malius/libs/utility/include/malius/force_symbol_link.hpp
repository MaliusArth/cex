...
//#define  MA_FORCE_SYMBOL_LINK(symbolName) void force_symbol_link_function_##symbolName(void) { extern char force_symbol_link_##symbolName; force_symbol_link_##symbolName = 0; }
//// This is placed in the source file of functions that are being excluded.
//#define  MA_FORCE_SYMBOL_LINK_EXCLUDED(symbolName) char force_symbol_link_##symbolName = 0
//#endif
//
//
